                ...
                <form method="POST" action="{{ route('suppliers.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}"
                            placeholder="Example: ABC Supply Sdn Bhd"
                    ...
                    <div>
                        ...
                        <input type="text" id="contact_person" name="contact_person"
                            value="{{ old('contact_person') }}" placeholder="Example: Mr Tan"
                            class="mt-2 w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <textarea id="address" name="address" rows="4" placeholder="Write supplier address..."

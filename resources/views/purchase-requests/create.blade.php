            ...
            <form method="POST" action="{{ route('purchase-requests.store') }}" class="space-y-6">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody id="items-table-body" class="divide-y divide-gray-200 bg-white">
                                <tr>
                                    ...
                                    <td class="px-4 py-4">
                                        <input type="number" name="items[0][estimated_price]" min="0"
                                            step="0.01" value="0"
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm lg:col-span-2">
                        ...
                        <textarea id="reason" name="reason" rows="5" placeholder="Example: Stock replenishment for low stock items..."
                            class="mt-2 w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('reason') }}</textarea>
                    </div>
                        ...
                        <div class="mt-5 space-y-4">
                            <div class="flex justify-between text-base">
                                ...
                                <span class="font-bold text-gray-900">
                                    RM <span id="estimated-total-text">0.00</span>
                                </span>
                            </div>

                            <p class="text-sm text-gray-500">
                                The request will be saved as Pending until a manager approves or rejects it.
                            </p>
                        </div>
                    </div>
                </div>
